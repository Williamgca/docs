...
<Steps>
    ...
    <Step title="Add a new store">
    Click on the **'Create store'** button, which you will find at the top right of the **'Stores'** page. By doing so, you will start the process of creating a new store in your organization. This will open a new page with a single field, in which you must enter the name of the store to be created.
    </Step>
    <Step title="Enter the name of your store">
    Enter the name of the store to be created and click on the **'Create'** button.
    </Step>
    <Step title="Access your new store">
    Finally, to manage your new store, you can click on the **'Change store'** button located in the top right corner of your account settings. This way, you can access and start configuring it within our platform.
    </Step>
</Steps>
